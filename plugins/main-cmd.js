...
console.log(`SPIDER-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923207047366'; // Replace this with the actual owner number
        const ownerName = 'RehanMD Official'; // Replace this with the owner's name
        const organization = 'SPIDER CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923207047366', '') + '+923207047366@s.whatsapp.net'], // Mention the owner
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_SPIDER-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> SPIDER-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ SPIDER-MD REPO: ${bot.REPO_LINK} 
┃
